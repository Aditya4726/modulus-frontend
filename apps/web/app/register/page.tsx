...
/* Backend integration: better-auth signUp.email creates the account and should
 * return a structured error for duplicate/invalid credentials. Social signup
 * uses callbackURL /projects and must establish the session cookie.
 */
					...
					<div className="w-full max-w-sm">
						...
						<div className="rounded-xl border border-slate-200 shadow-[0_8px_30px_rgba(0,0,0,0.06)] p-7">
							...
							<p className="text-slate-500 text-sm mb-5">
								Start tracing your agents in minutes.
							</p>
							...
							<form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
								<div>
									...
									<input
										className="w-full border border-slate-300 rounded-lg px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition disabled:opacity-60"
										type="text"
